...
const LANG = {
  fr: {
    ...
    hero_status:     "🔎 Recherche de stage SOC",
    ...
    about_p2:        "Je débute dans le domaine de la cybersécurité et je consolide mes bases chaque jour. Issue du développement full-stack, je commence à comprendre comment les applications sont conçues — et donc les points où elles peuvent être compromises.",
    about_p3:        "Mon quotidien s'articule autour de l'analyse de captures Wireshark, du suivi de tableaux de bord SIEM et de la pratique de labs CTF. Je cherche activement une opportunité en tant qu'analyste SOC junior pour continuer à apprendre et monter en compétences.",
    ...
    skill_net:       "Wireshark, tcpdump, nmap",
    ...
    skill_infra:     "Proxmox, Docker, Tailscale, Active Directory",
  ...
  en: {
    ...
    hero_status:     "🔎 Looking for a SOC internship",
    about_title:     "About",
    about_p1:        "I'm <strong>Marsha Walungua</strong>, an apprentice SOC analyst currently studying <strong>Réseaux, Infrastructure &amp; Sécurité</strong> at <strong>ORT Toulouse</strong>.",
    about_p2:        "I'm at the beginning of my cybersecurity journey and I'm building my foundations every day. Coming from a full-stack development background, I'm starting to understand how applications are built — and therefore where they can be compromised.",
    about_p3:        "My daily routine revolves around analyzing Wireshark captures, monitoring SIEM dashboards, and practicing CTF labs. I'm actively looking for a junior SOC analyst opportunity to keep learning and growing.",
