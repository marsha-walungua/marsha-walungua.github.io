...
const LANG = {
  fr: {
    ...
    nav_contact:     "Contact",
    hero_sub:        "apprentie SOC analyst",
    ...
    stat_ctf:        "Défis CTF",
    stat_langs:      "Langues",
    term_role:       "Apprentie Analyste SOC @ ORT Toulouse",
  ...
  en: {
    page_title:      "Marsha Walungua — SOC Analyst Portfolio",
    nav_about:       "About",
    nav_skills:      "Skills",
    nav_certs:       "Certs",
    ...
    term_role:       "SOC Analyst Apprentice @ ORT Toulouse",
    term_studying:   "CCNA &nbsp; Security+ &nbsp; Blue Team",
    ...
    contact_title:   "Contact",
    contact_intro:   "Looking for a SOC analyst apprentice? Let's talk.",
    contact_github:  "GitHub",
    contact_linkedin:"LinkedIn",
    contact_email:   "Email",
